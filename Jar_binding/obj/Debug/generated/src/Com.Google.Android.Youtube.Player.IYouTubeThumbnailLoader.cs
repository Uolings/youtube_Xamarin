...
#pragma warning restore 0649
	...
	public partial interface IYouTubeThumbnailLoader : IJavaObject {
		...
		bool HasNext {
			...
			[Register ("hasNext", "()Z", "GetHasNextHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")] get;
		}
		...
		bool HasPrevious {
			...
			[Register ("hasPrevious", "()Z", "GetHasPreviousHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")] get;
		}
		...
		[Register ("first", "()V", "GetFirstHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		void First ();
		...
		[Register ("next", "()V", "GetNextHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		void Next ();
		...
		[Register ("previous", "()V", "GetPreviousHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		void Previous ();
		...
		[Register ("release", "()V", "GetReleaseHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		void Release ();
		...
		[Register ("setPlaylist", "(Ljava/lang/String;)V", "GetSetPlaylist_Ljava_lang_String_Handler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		...
		[Register ("setPlaylist", "(Ljava/lang/String;I)V", "GetSetPlaylist_Ljava_lang_String_IHandler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
		...
		[Register ("setVideo", "(Ljava/lang/String;)V", "GetSetVideo_Ljava_lang_String_Handler:Com.Google.Android.Youtube.Player.IYouTubeThumbnailLoaderInvoker, Jar_binding")]
